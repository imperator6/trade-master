...
public class BittrexApi11 {
    ...
    public BittrexApi11(String apikey, String secret, int retryAttempts, int retryDelaySeconds) {
    ...
    public BittrexApi11(int retryAttempts, int retryDelaySeconds) {
